...
//     version 1.14.2
//     from Assets/_WebpgGame/_Alpina/JumpPlatforms/Controller/ThirdPerson.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_WebpgGame/_Alpina/JumpPlatforms/Controller/ThirdPerson.inputactions".
/// </summary>
/// <remarks>
...
public partial class @ThirdPerson: IInputActionCollection2, IDisposable
{
    ...
    ~@ThirdPerson()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, ThirdPerson.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, ThirdPerson.UI.Disable() has not been called.");
    }
    ...
    public struct PlayerActions
    {
        ...
        /// </summary>
        public PlayerActions(@ThirdPerson wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@ThirdPerson wrapper) { m_Wrapper = wrapper; }
        /// <summary>
